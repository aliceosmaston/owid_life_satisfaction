...
% of respondents replying "very happy" or "quite happy" when asked "Taking all things together, would you say you are very happy, quite happy, not very happy or not at all happy?"
...
cantril_chart_happiness <- 
  cantril %>% 
  filter(Country %in% c("Norway", "Australia", "Germany", "Zimbabwe", "Colombia", "Peru")) %>%
...
[OurWorldInData.org/happiness-happy](https://ourworldindata.org/grapher/share-of-people-who-say-they-are-happy) | CC BY
